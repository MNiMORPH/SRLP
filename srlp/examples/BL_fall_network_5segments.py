# ------------------------------------------------------------------------------
# SRLP Network Base Level Fall Example
# ------------------------------------------------------------------------------
...
# For testing
#net.evolve_threshold_width_river_network(nt=200, dt=dt*100)
...
net.update_z_ext_external_downstream(-100)
...
plt.ylabel('Elevation above outlet before\nbase-level fall [m]', fontsize=14)
plt.tight_layout()
plt.savefig('BLfall100.pdf') 
plt.show()
